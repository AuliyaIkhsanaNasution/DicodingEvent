...
class EventAvailableAdapter : ListAdapter<ListEventsItem, EventAvailableAdapter.EventViewHolder>(DIFF_CALLBACK) {
    ...
    class EventViewHolder(private val binding: ItemEventAvailableBinding) : RecyclerView.ViewHolder(binding.root) {
